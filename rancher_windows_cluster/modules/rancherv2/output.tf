...
output "secure_rke2_cluster_command" {
  value = rancher2_cluster_v2.rke2_win_cluster.cluster_registration_token.0.node_command
  depends_on = [
    rancher2_cluster_v2.rke2_win_cluster
  ]
}
...
output "secure_rke2_cluster_windows_command" {
  value = rancher2_cluster_v2.rke2_win_cluster.cluster_registration_token.0.windows_node_command
  depends_on = [
    rancher2_cluster_v2.rke2_win_cluster
  ]
}
